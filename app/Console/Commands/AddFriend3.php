...
class AddFriend3 extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'AddFriend3:perform';
     ...
     * @var string
     */
    protected $description = 'Add friend 3';
    ...
    {
        Log::info('Add friend 3' . date('Y-m-d H:i:s'));
        ...
        foreach ($users as $user){
            ...
            foreach ( $user->clones() as $clone ){
                ...
                if( $business->createdCloneAgo($clone) % 8 == 5 || $business->createdCloneAgo($clone) % 8 == 6 || $business->createdCloneAgo($clone) % 8 == 7  ){
                    //return 0;
                }else{
