...
<head>
    ...
    <title>INSTAVN - Nền tảng Instagram Marketing mạnh mẽ</title>
    <meta name="description" content="Nền tảng Instagram Marketing mạnh mẽ, tự động hóa công việc hằng ngày, làm việc mọi nơi, mọi thiết bị với hệ thống da nền tảng tiện dụng, Tiết kiệm thời gian, công cụ hữu ích + khóa học siêu khủng">
    <meta name="keywords" content="instavn, instagram, marketing, công cụ, tự động, follow, hack íntagram, auto follow, auto nhắn tin, auto comment, tăng follow, instavn, instagram, marketing, việt nam, auto, hệ thống, nền tảng, khóa, học,">
...
<body>
                        ...
                        <nav class="navbar navbar-expand-lg navbar-light">
                            ...
                            <div class="collapse navbar-collapse" id="ca-navbar">
                                <ul class="navbar-nav ml-auto" id="nav">
                                    ...
                                    <li class="nav-item"><a class="nav-link" href="#" target="_blank">Kiến Thức Insta</a></li>
                                </ul>
    ...
    <section class="wellcome_area clearfix" id="home">
            ...
            <div class="row h-100 align-items-center">
                <div class="col-12 col-md">
                    ...
                    <div class="get-start-area">
                        <!-- Form Start -->
                        <form action="https://instavn.com/login" method="post" class="form-inline">
                            <span class="trial">*
                            15 ngày dùng thử miễn phí                        </span>
                            <input type="submit" class="submit" value="Dùng thử MIỄN PHÍ">
                        </form>
                        <!-- Form End -->
                    </div>
                </div>
        ...
        <!-- Welcome thumb -->
        <div class="welcome-thumb wow fadeInDown" data-wow-delay="0.5s" style="bottom: 120px !important;">
            <img src="{{ asset('') }}/front/inc/themes/default/assets-index/img/bg-img/welcome-img.png" alt="">
        </div>
    </section>
    <!-- ***** Wellcome Area End ***** -->
            ...
            <div class="row">
                ...
                <div class="col-12 col-md-4">
                    <div class="single-special text-center wow fadeInUp" data-wow-delay="0.4s">
                        ...
                        <p>Hệ thống INSTAVN chạy trên cloud-server, ngay cả khi bạn tắt máy tính thì INSTAVN vẫn miệt mài hoạt động.</p>
                    </div>
                </div>
                <!-- Single Special Area -->
                <div class="col-12 col-md-4">
                    <div class="single-special text-center wow fadeInUp" data-wow-delay="0.6s">
                        ...
                        <h4>Proxy an toàn</h4>
                        <p>Bảo mật tài khoản Instagram của bạn bằng hệ thống Proxy thông minh tích hợp trong INSTAVN</p>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 col-xl-5 ml-xl-auto">
                        <div class="special_description_content">
                            ...
                            <p>Quản lý công việc mọi lúc mọi nơi trên mọi thiết bị cùng INSTAVN. Hãy bắt đầu để tiết kiệm thời gian, công sức & nhân lực, cùng tập trung nguồn lực phát triển kinh doanh.</p>
            ...
            <div class="row">
                ...
                <div class="col-12 col-sm-6 col-lg-4">
                    <div class="single-feature">
                        ...
                        <h5>Auto Comment</h5>
                        <p>Chức năng auto bình luận cho phép target vào địa điểm, hashtag, danh sách người dùng. Hỗ trợ chế độ Spintax Comment tránh nội dung bị spam.</p>
                    </div>
                </div>
                <!-- Single Feature Start -->
                <div class="col-12 col-sm-6 col-lg-4">
                    <div class="single-feature">
                        ...
                        <h5>Auto Like</h5>
                        <p>Auto thả thính theo target địa điểm, hashtag, người dùng. Tốc độ thả thính thông minh được tích hợp sẵn, giúp bảo vệ tài khoản an toàn.</p>
                    </div>
                </div>
                <!-- Single Feature Start -->
                <div class="col-12 col-sm-6 col-lg-4">
                    <div class="single-feature">
                        ...
                        <h5>Auto Copy Bài Đăng</h5>
                        <p>Tự động copy và đăng lại bài từ tài khoản người dùng khác. Target theo địa điểm, hashtag, người dùng. Có chức năng điều chỉnh tốc độ hợp lý.</p>
                    </div>
                </div>
                <!-- Single Feature Start -->
                <div class="col-12 col-sm-6 col-lg-4">
                    <div class="single-feature">
                        ...
                        <h5>Auto Nhắn Tin</h5>
                        <p>Chức năng này giúp bạn gửi tin nhắn chào mừng tới người theo dõi mới của bạn. Tích hợp tùy chọn tốc độ và Spintax DM giúp nội dung tin nhắn phong phú hơn.</p>
                    </div>
                </div>
                <!-- Single Feature Start -->
                <div class="col-12 col-sm-6 col-lg-4">
                    <div class="single-feature">
                        ...
                        <h5>Auto Follow/Unfollow</h5>
                        <p>Tự động Follow/Unfollow với target chi tiết giúp tối ưu hóa để tăng tương tác và tiếp cận nhiều đối tượng người dùng tiềm năng hơ</p>
                    </div>
                </div>
                <!-- Single Feature Start -->
                <div class="col-12 col-sm-6 col-lg-4">
                    <div class="single-feature">
                        ...
                        <h5>Lên Lịch Đăng</h5>
                        <p>Lên lịch hẹn giờ đăng cho chiến dịch tuyệt vời của bạn để tiết kiệm thời gian, bây giờ bạn không phải lo lắng khi nào nên đăng bài.</p>
                    </div>
                </div>
                <!-- Single Feature Start -->
                <div class="col-12 col-sm-6 col-lg-4">
                    <div class="single-feature">
                        ...
                        <p>Dễ dàng quản lý công việc bằng hệ thống thống kê thông minh được tích hợp sẵn. Chế độ Tìm Kiếm Hashtag Tiềm Năng được tích hợp sẵn trong các module trên.</p>
                    </div>
                </div>
                <!-- Single Feature Start -->
                <div class="col-12 col-sm-6 col-lg-4">
                    <div class="single-feature">
                        ...
                        <p>Hệ thống INSTAVN được chạy trên nền tảng đám mây nên ngay cả khi bạn tắt thiết bị của mình thì INSTAVN vẫn hoạt động theo cài đặt.</p>
                    </div>
                </div>
                <!-- Single Feature Start -->
                <div class="col-12 col-sm-6 col-lg-4">
                    <div class="single-feature">
                        ...
                        <h5>Tài liệu & khóa học độc quyền</h5>
                        <p>Khi là thành viên hệ thống INSTAVN, bạn sẽ được tiếp cận với những tài liệu độc quyền về IG cũng như ưu đãi lớn cho khóa học IG từ iWolf Marketing.</p>
                    </div>
                </div>
            </div>
            ...
            <div class="row no-gutters">
                ...
                <div class="col-12 col-md-6 col-lg-3 fix-bang-gia" style="max-width: 20%;">
                    <div class="single-price-plan active text-center">
                        ...
                        <div class="package-description">
                            <p style="color: red;">Chỉ 1 TK Instagram</p>
                            <p></p>
                            <div class="feature-title">Automation Functions</div>
                            <div>
                                <span>Auto Follow</span>
                                <br>
                                <span style="color:red;" class="not">Auto Unfollow</span>
                                <br>
                                <span>Auto Like</span>
                                <br>
                                <span>Auto Comment</span>
                                <br>
                                <span>Auto Nhắn Tin</span>
                                <br>
                                <span>Auto Copy Ảnh</span>
                            </div>
                            <p></p>
                            <div class="feature-title">Định dạng bài</div>
                            <div>
                                <span class="">Hình ảnh</span>,
                                <span class="not">Video</span>,
                                <br>
                                <span style="color: red;">Story (Chỉ Ảnh)</span>,
                                <br>
                                <span style="color: red;">Album (Chỉ Ảnh)</span>
                            </div>
                            <p><span class="not">Hỗ trợ Spintax Auto Comment</span></p>
                            <p style="color: red;">Bộ nhớ: <span class="color-primary fw-500">50MB</span>
                            </p>
                        </div>

                        <div class="plan-button">
                            <a href="signup.html" class="button button--dark button--oval">Purchase</a>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="single-price-plan active text-center">
                        ...
                        <div class="package-description">
                            <p style="color: #8BC34A;">
                                Chỉ 1 TK Instagram </p>
                            <p>
                                <div class="feature-title">Automation Functions</div>
                                <div>
                                    <span>Auto Follow</span>
                                    <br />
                                    <span style="color: #8BC34A;">Auto Unfollow</span>
                                    <br />
                                    <span>Auto Like</span>
                                    <br />
                                    <span>Auto Comment</span>
                            ...
                            <div>
                                <span style="color: #8BC34A;" class="">Hình ảnh</span>,
                                <span style="color: #8BC34A;" class="">Video</span>,

                                <br>

                                <span style="color: #8BC34A;">Story (Ảnh+Video)</span>,

                                <br>

                                <span style="color: #8BC34A;">Album (Ảnh+Video)</span>
                            </div>
                            <p><span style="color: #8BC34A;" class="">Hỗ trợ Spintax Auto Comment</span></p>
                            <p style="color: #8BC34A;">Bộ nhớ:
                        ...
                        <!-- Plan Button  -->
                        <div class="plan-button">
                            <a href="signupc4e2.html?package=1" class="button button--dark button--oval">Purchase</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-12 col-md-6 col-lg-3 fix-bang-gia" style="max-width: 20%;">
                    ...
                    <div class="single-price-plan active text-center">
                        ...
                        <!-- Plan Button  -->
                        <div class="plan-button">
                            <a href="signupe41c.html?package=2" class="button button--dark button--oval">Purchase</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-12 col-md-6 col-lg-3 fix-bang-gia" style="max-width: 20%;">
                    ...
                    <div class="single-price-plan active text-center">
                        ...
                        <!-- Plan Button  -->
                        <div class="plan-button">
                            <a href="signup94f0.html?package=3" class="button button--dark button--oval">Purchase</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-12 col-md-6 col-lg-3 fix-bang-gia" style="max-width: 20%;">
                    ...
                    <div class="single-price-plan active text-center">
                        ...
                        <!-- Plan Button  -->
                        <div class="plan-button">
                            <a href="signupc500.html?package=7" class="button button--dark button--oval">Purchase</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-12 col-md-6 col-lg-3 fix-bang-gia" style="max-width: 20%;">
                    ...
                    <div class="single-price-plan active text-center">
                        ...
                        <!-- Plan Button  -->
                        <div class="plan-button">
                            <a href="signupd97f.html?package=8" class="button button--dark button--oval">Purchase</a>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="slider slider-for">
                        ...
                        <div class="client-feedback-text text-center">
                            ...
                            <div class="client-description text-center">
                                <p>“ Cảm ơn iWolf Marketing đã hiểu những người làm social marketing cần gì. Một công cụ tuyệt vời để tăng hiệu quả tiếp cận tới tệp khách hàng tiềm năng. ”</p>
                            </div>
                        ...
                        <div class="client-feedback-text text-center">
                            ...
                            <div class="client-description text-center">
                                <p>“ Instagram marketing còn là một sân chơi mới mẻ với tôi, nhưng nhờ có INSTAVN cũng như những khóa học và tài liệu tuyệt vời về IG của iWolf đã giúp tôi tự tin hơn khi tham chiến thị trường đầy tiềm năng này. ”</p>
                            </div>
                            <div class="star-icon text-center">
                                <i class="ion-ios-star"></i>
                                <i class="ion-ios-star"></i>
                        ...
                        <div class="client-feedback-text text-center">
                            ...
                            <div class="client-description text-center">
                                <p>“ Mười điểm cho những công cụ này của iWolf Marketing. Automation không phải là lười, mà sẽ giúp doanh nghiệp tiết kiệm chi phí nhân lực và tăng năng suất làm việc của nhân viên. ”</p>
                            </div>
                            <div class="star-icon text-center">
                                <i class="ion-ios-star"></i>
                                <i class="ion-ios-star"></i>
                        ...
                        <div class="client-feedback-text text-center">
                            ...
                            <div class="client-description text-center">
                                <p>“ Đơn giản, tiện lợi và mạnh mẽ đó là 3 từ cảm nhận của tôi về INSTAVN. Thật tuyệt vời, nó giúp nâng cao năng suất làm việc của nhân viên, và keep-track công việc của họ dễ dàng hơn. Cảm ơn iWolf! ”</p>
                            </div>
                            <div class="star-icon text-center">
                                <i class="ion-ios-star"></i>
                                <i class="ion-ios-star"></i>
            ...
            <div class="row align-items-center">
                <div class="col-md-8">
                    <div class="membership-description">
                        ...
                        <p>Bạn sẽ được trả lên tới 35% hoa hồng từ việc giới thiệu INSTAVN. 35% hoa hồng này sẽ được tính theo tất cả những thanh toán từ người được giới thiệu.</p>
                    </div>
                </div>
                <div class="col-md-4">
                        ...
                        <div class="member-image">
                            ...
                            <div class="team-hover-effects">
                                <div class="team-social-icon">
                                    <a href="https://www.facebook.com/InstaVN.Official/" target="_blank"><i class="fa fa-facebook" aria-hidden="true"></i></a>
            ...
            <div class="row">
                <div class="col-md-6">
                    ...
                    <div class="address-text">
                        <p><span>Địa chỉ: </span>Tòa C3, Nguyễn Cơ Thạch, Hà Nội</p>
                    </div>
                    <div class="phone-text">
                        <p><span>Điện thoại: </span><a href='tel:+84964115288'>0964-115-288</a></p>
                    </div>
                    <div class="email-text">
                        <p><span>Email: </span><a href='mailto:cskh@instavn.com'>cskh@instavn.com</a></p>
                    </div>
                </div>
                <div class="col-md-6">
                    <!-- Form Start-->
    ...
    <footer class="footer-social-icon text-center section_padding_70 clearfix">
        ...
        <div class="footer-social-icon">
            <a href="https://www.facebook.com/page.instavn" target="_blank"><i class="fa fa-facebook" aria-hidden="true"></i></a>
            <a href="https://www.youtube.com/" target="_blank"><i class="fa fa-youtube" aria-hidden="true"></i></a>
            <a href="https://www.instagram.com/instavn.page/" target="_blank"> <i class="fa fa-instagram" aria-hidden="true"></i></a>
            <a href="https://www.instagram.com/iwolf_marketing" target="_blank"><i style="red" class="fa fa-instagram" aria-hidden="true"></i></a>
        </div>
        ...
        <div class="copyright-text">
            <p>INSTAVN &copy; Copyright 2018. Powered by <a href="https://www.xn--si-5ja.com/" target="_blank">iWolf Marketing</a></p>
