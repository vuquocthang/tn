                            ...
                            <form class="form-horizontal" action="#" method="post">
                                <fieldset>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="col-md-6" name="type" class="form-control">
                                    ...
                                    <div class="form-group">
                                        <label class="col-md-3 control-label" for="keyword">Keyword</label>
                                        <div class="col-md-6">
                                            <input id="keyword" name="keyword" type="text" placeholder="Keyword" class="form-control">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6">
                                            <textarea class="form-control resize_vertical" id="message" name="message" placeholder="Nội dung" rows="5"></textarea>
                                        </div>
                                    </div>
