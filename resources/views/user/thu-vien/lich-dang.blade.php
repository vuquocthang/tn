				...
				<div class="portlet box primary">
                            ...
                            <div class="portlet-body flip-scroll">
                                <table class="table table-bordered table-striped table-condensed flip-content">
                                    ...
                                    <tbody>
										@foreach($user->postCatSchedules()->select('post_cat_schedule.*')->orderBy('created_at', 'DESC')->get() as $index => $item )
                                        <tr>
                                            ...
                                            <th><a data-toggle="modal" data-href="#sua-lich-dang-{{ $item->id }}" href="#sua-lich-dang-{{ $item->id }}">Sửa</a></th>
											<th><a href="{{ route('thu-vien.xoa-lich-dang', $item->id) }}" onclick="return confirm('Chắc chắn xóa ?')" >Xóa</a></th>
                                        </tr>
										@endforeach
